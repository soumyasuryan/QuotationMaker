...
export default function Home() {
  return (
    <div className="   min-h-screen">
     <Navbar></Navbar>
     <div className="flex flex-col items-center justify-center md:pt-20 pt-40 mx-2">
      ...
      <h4 className="text-gray-300 text-sm sm:text-lg text-center sm:w-140 w-80 ">Minding the hectic part so that you can mind the real business...
